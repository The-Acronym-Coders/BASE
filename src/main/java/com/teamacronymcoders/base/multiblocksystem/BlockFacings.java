...
public final class BlockFacings {
	...
	public IBlockState toBlockState(IBlockState state) {
		...
		return state.withProperty(FACING_DOWN, isSet(EnumFacing.DOWN)).withProperty(FACING_UP, isSet(EnumFacing.UP))
				.withProperty(FACING_WEST, isSet(EnumFacing.WEST)).withProperty(FACING_EAST, isSet(EnumFacing.EAST))
				.withProperty(FACING_NORTH, isSet(EnumFacing.NORTH))
				.withProperty(FACING_SOUTH, isSet(EnumFacing.SOUTH));
	}
	 ...
	 *            filled in following the order in EnumFacing.VALUES
	 * @return a BlockFacing object
	 */
	...
	public String toString() {
		...
		return String.format("Facings: %s%s%s%s%s%s", isSet(EnumFacing.DOWN) ? "DOWN " : "",
				isSet(EnumFacing.UP) ? "UP " : "", isSet(EnumFacing.NORTH) ? "NORTH " : "",
				isSet(EnumFacing.SOUTH) ? "SOUTH " : "", isSet(EnumFacing.WEST) ? "WEST " : "",
				isSet(EnumFacing.EAST) ? "EAST " : "");
	}
