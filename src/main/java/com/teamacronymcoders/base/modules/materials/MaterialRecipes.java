...
public class MaterialRecipes {
    public static void init() {
        ...
        if (copper != null) {
            ...
            //GameRegistry.addSmelting(new ItemStack(BaseBlocks.oreBlockMap.get(copper)), new ItemStack(ModuleMaterials.INGOT, 1, MaterialRegistry.getIDFromMaterial(copper)), 50);
        ...
        if (tin != null) {
            ...
            //GameRegistry.addSmelting(new ItemStack(BaseBlocks.oreBlockMap.get(tin)), new ItemStack(ModuleMaterials.INGOT, 1, MaterialRegistry.getIDFromMaterial(tin)), 50);
        ...
        if (lead != null) {
            ...
            //GameRegistry.addSmelting(new ItemStack(BaseBlocks.oreBlockMap.get(lead)), new ItemStack(ModuleMaterials.INGOT, 1, MaterialRegistry.getIDFromMaterial(lead)), 50);
        }
        ...
        if (silver != null) {
            ...
            //GameRegistry.addSmelting(new ItemStack(BaseBlocks.oreBlockMap.get(silver)), new ItemStack(ModuleMaterials.INGOT, 1, MaterialRegistry.getIDFromMaterial(silver)), 50);
        ...
        if (electrum != null) {
            ...
            //GameRegistry.addSmelting(new ItemStack(BaseBlocks.oreBlockMap.get(electrum)), new ItemStack(ModuleMaterials.INGOT, 1, MaterialRegistry.getIDFromMaterial(electrum)), 50);
        ...
        if (nickel != null) {
            ...
            //GameRegistry.addSmelting(new ItemStack(BaseBlocks.oreBlockMap.get(nickel)), new ItemStack(ModuleMaterials.INGOT, 1, MaterialRegistry.getIDFromMaterial(nickel)), 50);
        ...
        if (aluminum != null) {
            ...
            //GameRegistry.addSmelting(new ItemStack(BaseBlocks.oreBlockMap.get(aluminum)), new ItemStack(ModuleMaterials.INGOT, 1, MaterialRegistry.getIDFromMaterial(aluminum)), 50);
